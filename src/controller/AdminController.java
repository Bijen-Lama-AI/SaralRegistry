...
/**
 * Controller for admin actions following MVC pattern.
 * Handles all business logic and mediates between Model and View.
 * @author bijen
 */
public class AdminController {
    ...
    public boolean login(String inputId, String inputPassword) {
        try {
            ...
            if (inputId == null || inputId.trim().isEmpty()) {
                if (view != null) view.showError("Admin ID cannot be empty.");
                return false;
            }
            
            if (inputPassword == null || inputPassword.trim().isEmpty()) {
                if (view != null) view.showError("Password cannot be empty.");
                return false;
            }
            ...
            if (loggedAdmin == null) {
                loggedIn = false;
                if (view != null) view.showError("Invalid Admin ID or Password.");
                return false;
            }
            ...
            if (view != null) view.showError("Login error: " + e.getMessage());
            return false;
        }
    }
    ...
    public List<CitizenModel> getAllCitizens() {
        try {
            ...
            if (view != null) view.showError("Error retrieving citizens: " + e.getMessage());
    ...
    private boolean ensureLoggedIn() {
        if (!loggedIn || currentAdmin == null) {
            if (view != null) view.showError("Please login as admin first.");
            return false;
        }
        return true;
    }
    ...
    private void loadInitialAdmins() {
        try {
            ...
            if (view != null) view.showError("Failed to load initial admins: " + e.getMessage());
        }
    }
}